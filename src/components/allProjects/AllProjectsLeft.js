    ...
    <ThemeContext.Consumer>
      {({ darkMode }) => {
        const heroData = {
          ...
          body: (
            <span>
              Here's a selected list of projects that I've worked on through my
              journey of learning new tools and technologies. Have a project in
              mind?{' '}
              <Link
            ...
            <div>
              <Link
                ...
                className={`items-center text-primary-${
                  darkMode ? 'light' : 'dark'
                } hidden mb-10 lg:inline-flex link-${
                  darkMode ? 'light' : 'dark'
                }`}
              >
